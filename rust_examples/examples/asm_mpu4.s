...
.text
.section .init 
# This test checks if an interrupt happens when reading an allowed area outside of stack with the wrong permissions.
# EXPECTED BEHAVIOR:
...
init:   
        ...
        addi    t1, t1, 0b1110     # bits 0 is for reading enable, bit 1 is for writing enable and bits 18:2 is for the length. length + start address is the higher limit. all access below is granted
