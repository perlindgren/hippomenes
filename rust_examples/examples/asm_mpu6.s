...
.text
.section .init 
# This test checks if an interrupt happens when reading in a disallowed address right below the allowed area outside of stack.
# EXPECTED BEHAVIOR:
...
init:   
        ...
        addi    t1, t1, 0b1111     # bits 0 is for reading enable, bit 1 is for writing enable and bits 18:2 is for the length in words. length + start address is the higher limit. all access below is granted
        csrw    0x400, t1       #entry for accessing between 0x400 and 0x408
